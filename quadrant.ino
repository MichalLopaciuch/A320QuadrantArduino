...
// LEFT THRUST LEVER
const int L_THRUST_PIN = A0; // thrust analog input pin
const int L_THRUST_REV_SW = 0; // virtual button pin
const int L_THRUST_REV_VAL = 523; // breakpoint where revers are applied
bool L_REV_ON = false; // virtual button to indicate left reverse
int L_RAW_THRUST = 0; // raw analog data from potentiometer
int L_CPT_THRUST = 0; // computed data from potentiometer
